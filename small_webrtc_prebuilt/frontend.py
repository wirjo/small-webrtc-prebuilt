...
dist_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "client-new", "dist"))
...
if not os.path.isdir(dist_dir):
    ...
    raise RuntimeError(
        f"Static frontend build not found at: {dist_dir}. Please run `npm run build` in the client-new directory."
    )
